...
$(document).ready(function(){
        $("#report1").click(function(){
            ...
            $("div.completeReport").printArea( options );
        });
});
</script>
						...
						<nav class="navbar navbar-default">
						  <div class="container-fluid">
							<ul class="nav navbar-nav">
							  <li class="active"><a href="paymentReport.php">Complete</a></li>
							  ...
							  <li><a href="notPayTransport.php">Not Transport Pay</a></li>
							</ul>
						  </div>
						</nav>
					<div class="row" style="padding:10px;">
					<form method="get" action="paymentReport.php">
						<div class="form-group row col-sm-3">
							<div class="col-sm-12">
											...
											<div class="row col-sm-12">
															<a href="javascript:void(0);" class="btn btn-primary" id="report1">Print</a>
														</div>
											<?php
													}
												?>
